  ...
  config = {
    ...
    home.activation.checkLinkTargets = lib.hm.dag.entryBefore [ "writeBoundary" ] (
      let
        ...
        '';
      in
      if cfg.fileActivator == "putter" then putterCheckLinkTargets else legacyCheckLinkTargets
    );
    ...
    home.activation.linkGeneration = lib.hm.dag.entryAfter [ "writeBoundary" ] (
      let
        ...
        '';
      in
      if cfg.fileActivator == "putter" then putterLinkGeneration else legacyLinkGeneration
    );
